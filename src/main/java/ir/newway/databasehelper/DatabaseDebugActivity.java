...
public class DatabaseDebugActivity extends Activity implements OnItemClickListener {
...
// all global variables
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //in the below line Change the text 'yourCustomSqlHelper' with your custom sqlitehelper class name
        dbm = new SQLiteHelper(this, mDatabaseName, null, mDatabaseVersion);
        ...
        select_table.setOnItemSelectedListener(new OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> parent,
                ...
                if (pos != 0) {
                    ...
                    ArrayAdapter<String> adapter = new ArrayAdapter<String>(DatabaseDebugActivity.this,
                    ...
                    if (c2 != null) {
                        ...
                        spinnertable.setOnItemSelectedListener((new AdapterView.OnItemSelectedListener() {
                            ...
                            public void onItemSelected(AdapterView<?> parentView, View selectedItemView, int position, long id) {
                                    ...
                                    runOnUiThread(new Runnable() {
                                        ...
                                        public void run() {
                                            if (!isFinishing()) {
                                                ...
                                                new AlertDialog.Builder(DatabaseDebugActivity.this)
                                ...
                                if (spinnertable.getSelectedItem().toString().equals("Add row to this table")) {
                                    ...
                                    final ScrollView addrowsv = new ScrollView(DatabaseDebugActivity.this);
                                    ...
                                    final RelativeLayout addnewlayout = new RelativeLayout(DatabaseDebugActivity.this);
                                    ...
                                    for (int i = 0; i < addnewrownames.size(); i++) {
                                        ...
                                        et.setId(k);
                                        final LinearLayout ll = new LinearLayout(DatabaseDebugActivity.this);
                        ...
                        for (int k = 0; k < c2.getColumnCount(); k++) {
                            LinearLayout cell = new LinearLayout(DatabaseDebugActivity.this);
    ...
    public void updateDeletePopup(int row) {
        ...
        final RelativeLayout lp = new RelativeLayout(this);
        lp.setBackgroundColor(Color.WHITE);
        RelativeLayout.LayoutParams lay = new RelativeLayout.LayoutParams(RelativeLayout.LayoutParams.WRAP_CONTENT, RelativeLayout.LayoutParams.WRAP_CONTENT);
        lay.addRule(RelativeLayout.ALIGN_PARENT_TOP);

        final ScrollView updaterowsv = new ScrollView(this);
        LinearLayout lcrud = new LinearLayout(this);
        ...
        ArrayAdapter<String> crudadapter = new ArrayAdapter<String>(this,
